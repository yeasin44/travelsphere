...
const Clients = () => {
  return (
    <div className="max-w-screen-lg mx-auto py-12">
      <h2 className="text-center text-2xl p-6 font-bold">What my client say</h2>
      <div className="border-2 p-12 bg-slate-800 rounded-xl">
        <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-4 md:gap-20 gap-12 mt-6">
          <div className="border-2 rounded-xl border-slate-900 p-6 bg-white">
            ...
            <p>
              A tour guide or a tourist guide is a person who provides
              assistance, information on cultural, historical and contemporary
              heritage to people on organized sightseeing and individual clients
              at educational{" "}
            </p>
          </div>
          <div className="border-2 rounded-xl border-slate-900 p-6 bg-white">
